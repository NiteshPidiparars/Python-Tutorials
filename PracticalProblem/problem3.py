...
reverse1 = mylist[:]  # save the copy of mylist in reverse1
reverse1.reverse()

reverse2 = mylist[::-1]  # save the copy of mylist in reverse2
print(f"My First reversed list of {mylist} is {reverse1}")
print(f"My Second reversed list of {mylist} is {reverse2}")

reverse3 = mylist[:]  # save the copy of mylist in reverse3
